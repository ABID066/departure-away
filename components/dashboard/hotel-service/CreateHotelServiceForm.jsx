...
export default function CreateHotelServiceForm() {
    ...
    useEffect(() => {
        try {
            ...
            if (userData) {
                ...
                // Check if user role is allowed to create hotel services
                if (user.role === "user") {
                    setUnauthorized(true);
                    setError("Only freelancers and agencies can create hotel services.");
                    return;
                }
    ...
    const handleSubmit = async (e) => {
        ...
        if (unauthorized) {
            setError("You are not authorized to create hotel services.");
            return;
        }
        ...
        try {
            ...
            const response = await fetch('https://royolex.vercel.app/api/v1/hotel/create-hotel', {
                method: 'POST',
                headers: {
            ...
            console.log("Hotel service created successfully:", result);
            // Redirect to hotel service listing
            router.push('/dashboard/hotel-service');

        } catch (error) {
            console.error("Error creating hotel service:", error);
            setError(error.message || "Failed to create hotel service. Please try again.");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="p-4 md:p-6">
            <div className="bg-white rounded-lg shadow p-4 md:p-6">
                <h2 className="text-lg md:text-xl font-semibold mb-4 md:mb-6">Create New Hotel Service</h2>
                ...
                {unauthorized ? (
                    <div className="text-center py-8">
                        <div className="mb-4 text-red-500 font-medium">
                            You don't have permission to create hotel services.
                        </div>
                        <p className="mb-4 text-gray-600">
                            Only freelancers and agencies can create hotel services. If you believe this is an error, please contact support.
                        </p>
                        <button
                            onClick={() => router.push('/')}
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-6 md:mt-8 flex flex-col sm:flex-row sm:justify-end gap-3">
                            <button
                                ...
                                onClick={() => router.push('/dashboard/hotel-service')}
                            ...
                            >
                                ...
                                ) : isUploading ? 'Uploading Images...' : 'Create Hotel Service'}
                            </button>
                        </div>
                    </form>
                )}
