...
export default function FlightOffersGrid() {
    const { offers, filteredOffers, resetFilters, loading, error } = useFlightOffers();
        ...
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {displayOffers.map((offer) => (
                    <FlightOffersCard key={offer.id} offer={offer} />
                ))}
            </div>
            ...
            {filteredOffers.length === 0 && offers.length > 0 && (
                <div className="text-center py-10">
                    <p className="text-gray-500">
                        No flight offers found matching your filters.
                    </p>
                    <button
            ...
            {offers.length === 0 && !loading && (
                <div className="text-center py-10">
                    <p className="text-gray-500">
                        No flight offers available at the moment.
                    </p>
                </div>
            )}
        </>
