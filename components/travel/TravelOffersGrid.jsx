...
export default function TravelOffersGrid() {
    const { offers, filteredOffers, resetFilters, loading, error } = useTravelOffers();
    ...
    return (
        <>
            ...
            {filteredOffers.length === 0 && offers.length > 0 && (
                <div className="text-center py-10">
                    <p className="text-gray-500">
                        No travel offers found matching your filters.
                    </p>
                    <button
            ...
            {offers.length === 0 && !loading && (
                <div className="text-center py-10">
                    <p className="text-gray-500">
                        No travel offers available at the moment.
                    </p>
                </div>
            )}
        </>
