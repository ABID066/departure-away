...
export default function HotelOffersGrid() {
    const { offers, filteredOffers, resetFilters, loading, error } = useHotelOffers();
    ...
    return (
        <>
            ...
            {filteredOffers.length === 0 && offers.length > 0 && (
                <div className="text-center py-10">
                    <p className="text-gray-500">
                        No hotel offers found matching your filters.
                    </p>
                    <button
            ...
            {offers.length === 0 && !loading && (
                <div className="text-center py-10">
                    <p className="text-gray-500">
                        No hotel offers available at the moment.
                    </p>
                </div>
            )}
        </>
